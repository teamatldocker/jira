...
|---------|--------|-------|------------|
| Jira Software | 7.6.0 | 7.6.0, latest, latest.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Service Desk | 3.9.0 | servicedesk, servicedesk.3.9.0, servicedesk.de, servicedesk.3.9.0.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Core | 7.6.0 | core, core.7.6.0, core.de, core.7.6.0.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
