...
|---------|--------|-------|------------|
| Jira Software | 7.6.2 | 7.6.2, latest, latest.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Service Desk | 3.9.2 | servicedesk, servicedesk.3.9.2, servicedesk.de, servicedesk.3.9.2.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Core | 7.6.2 | core, core.7.6.2, core.de, core.7.6.2.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
