...
|---------|--------|-------|------------|
| Jira Software | 7.3.5 | 7.3.5, latest, latest.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Service Desk | 3.4.2 | servicedesk, servicedesk.3.4.2, servicedesk.de, servicedesk.3.4.2.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Core | 7.3.5 | core, core.7.3.5, core.de, core.7.3.5.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
