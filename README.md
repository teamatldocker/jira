...
|---------|--------|-------|------------|
| Jira Software | 7.4.1 | 7.4.1, latest, latest.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Service Desk | 3.6.1 | servicedesk, servicedesk.3.6.1, servicedesk.de, servicedesk.3.6.1.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
| Jira Core | 7.4.1 | core, core.7.4.1, core.de, core.7.4.1.de | [Dockerfile](https://github.com/blacklabelops/jira/blob/master/Dockerfile) |
